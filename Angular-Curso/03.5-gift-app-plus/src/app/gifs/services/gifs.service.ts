...
export class GifsService {
  ...
  */
  ...
  /*
  *Creamos la funcion en donde vamos a llamar al localstorage para verificar si ya se guardo algo
  *anteriormente
 */
  private loadLocalStorage():void{
    ...
    //*Regresamos el valor guardado como ultimo, de esta manera al recargar se mostrara la ultima busqueda
